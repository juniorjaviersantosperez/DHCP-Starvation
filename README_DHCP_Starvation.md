# 🛡️ Ataque DHCP Starvation — Documentación Técnica
...
├── dhcp_starvation.py                         ← Script del ataque
├── images/
│   ├── imagen_01_topologia.png
│   ├── imagen_02_dhcp_pool_r1.png
│   ├── imagen_03_reconexion_interfaz_victima.png
│   ├── imagen_04_ataque_iniciado.png
│   ├── imagen_05_pool_agotado_victima.png
│   └── imagen_06_contramedida_port_security.png
└── video/
    └── dhcp_starvation_demo.mp4               ← Video de demostración (máx. 5 min)
```
